...
private:
    ...
    void rasterize_triangle(const Triangle& t,
                            ...
                            const std::vector<light>& viewspace_lights, std::vector<std::vector<float>> shadowBuffers, 
...
private:
    ...
    std::map<Eigen::Vector3f, std::vector<std::vector<std::vector<bool>>>> shadowMap;
