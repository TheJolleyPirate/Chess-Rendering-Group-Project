...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload &payload) {
    ...
    if (payload.texture) {
        ...
        Eigen::Vector2f textureCoords = payload.tex_coords;
        auto[u, v] = processUandV(textureCoords.x(), textureCoords.y());
...
Eigen::Vector3f bump_fragment_shader(const fragment_shader_payload &payload) {
    ...
    float dU = kh * kn * (f(u+1/w,v)-f(u,v));
    float dV = kh * kn * (f(u,v+1/h)-f(u,v));
